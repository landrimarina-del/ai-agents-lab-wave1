...
**Versione:** 2.0
**Data:** 2026-03-04
**Autore:** UX Mapper Agent

---

## §1 Assunzioni UX

1. **Contesto B2B enterprise**: la piattaforma è destinata esclusivamente a utenti professionali interni all'organizzazione; nessun accesso consumer o self-service pubblico è previsto in Wave 1.
2. **SSO obbligatorio**: l'autenticazione avviene unicamente tramite OIDC/PKCE SSO; non sono previsti form di login locali né recupero password nativo.
